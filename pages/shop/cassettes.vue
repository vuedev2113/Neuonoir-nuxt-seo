...
const response = await GqlGetCassettes();
...
useHead({
	...
	meta: [
		...
		{ name: 'keywords', content: 'cassettes, music, Romania' },
		{ property: 'og:title', content: 'Neuronoir | Cassettes' },
		...
		{ property: 'og:url', content: 'https://www.neuronoir.art/shop/cassettes' },
	]
})
</script>
